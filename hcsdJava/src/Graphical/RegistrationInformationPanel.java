 ...
 */
public class RegistrationInformationPanel extends JPanel implements
		ActionListener {
	// initiate variables
	...
	private JTextField firstNameText, lastNameText, birthDateText,
			streetAddressText, postcodeText, contactNoText, amountPaidText;
	...
	JLabel failure = new JLabel(
			"Registration Failed, please check user details");
	...
	// returning how many check ups, hygienists and repairs is included in the
	// plan
	...
	public int getHyg() {
		...
		} else if (getHealthcareComboBox().equals("NHS Free Plan")
				|| getHealthcareComboBox().equals("Maintenance Plan")) {
			return 2;
		} else {
			return 4;
		}
